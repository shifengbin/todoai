...
**Reason**: The application now supports multiple independent terminal sessions under a single project.
**Migration**: Use `Maintain Multiple Runtime Shell Sessions Per Project` and route each shell operation by terminal identifier.
